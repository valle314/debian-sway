...
# git clone https://github.com/mpv-player/mpv --branch v0.39.0 --single-branch --depth 1
git clone https://github.com/mpv-player/mpv --branch v0.37.0 --single-branch --depth 1
cd ./mpv
mkdir -p subprojects
# git clone https://code.videolan.org/videolan/libplacebo --branch v7.349.0 --single-branch --depth 1 --recursive subprojects/libplacebo
